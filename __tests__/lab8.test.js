describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    let root = await testItem.getProperty('shadowRoot');
    let button = await root.$('button');
    await button.click()
    let innertex = await button.getProperty('innerText');
    let texVal = await innertex.jsonValue();
    console.log("hello");
    await expect(texVal).toBe("Remove from Cart");
    await button.click();
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    let cartcount = await cartInnerText.jsonValue();
